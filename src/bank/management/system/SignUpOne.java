...
public class SignUpOne extends JFrame implements ActionListener {
    ...
    long random;
    JTextField nameTextField, dobTextField, fathernameTextField, mothernameTextField, mailTextField, addressTextField, cityTextField, divisionTextField, pinTextField;
    JButton next;
    ...
    SignUpOne()
    {
        ...
        mail.setBounds(100, 390, 400, 30);
        add(mail);
        
        mailTextField = new JTextField();
        mailTextField.setFont(new Font("Raleway", Font.BOLD, 14));
        mailTextField.setBounds(300, 390, 400, 30);
        add(mailTextField);
        
        JLabel mStatus = new JLabel("Marial Status:");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                String query = "insert into signup values('"+formno+"','"+name+"','"+fathername+"','"+mothername+"','"+dob+"','"+gender+"','"+mail+"','"+mStatus+"','"+address+"','"+city+"','"+division+"','"+pin+"')";
