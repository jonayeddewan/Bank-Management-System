...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pin) {
        ...
        b1.setBounds(152, 415, 150, 35);
        l3.add(b1);

        b2.setBounds(370, 415, 150, 35);
        l3.add(b2);

        b3.setBounds(152, 448, 150, 35);
        l3.add(b3);

        b4.setBounds(370, 448, 150, 35);
        l3.add(b4);

        b5.setBounds(152, 480, 150, 35);
        l3.add(b5);

        b6.setBounds(370, 481, 150, 35);
        l3.add(b6);

        b7.setBounds(370, 516, 150, 35);
        l3.add(b7);
